...
M0, M0.1/B00, M1, M2, M3, and M4 are complete. The next permitted atomic task is M5/PCAD-CMP-001:
implement the scan-to-reference deviation field without changing status/exit-code semantics or
